          ...
          <Card component={motion.div} variants={item} className="flex flex-col w-full px-32 pt-24 mb-16">
            ...
            <CardContent className="px-32 py-24">
              <div className="mb-24">
                ...
                <Typography className="font-medium" color="text.secondary">{entity?.uid}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Name</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.name}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Code</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.code}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">CG Supervisor</Typography>
                <Typography className="font-medium" color="text.secondary">{users && users[entity?.cg_supervisor]?.email}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Episodic</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.is_episodic ? 'Yes' : 'No'}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Start Date</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.start_date && format(new Date(entity.start_date), 'dd-MM-y hh:mm:ss')}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Due Date</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.due_date && format(new Date(entity.due_date), 'dd-MM-y hh:mm:ss')}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Resolution</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.resolution}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Start Frame</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.start_frame}</Typography>
              </div>
              <div className="mb-24">
                <Typography className="mb-4 text-15">Created Date</Typography>
                <Typography className="font-medium" color="text.secondary">{entity?.created_at && format(new Date(entity.created_at), 'dd-MM-y hh:mm:ss')}</Typography>
              </div>
