  ...
  return (
    <>
      <Typography className="mb-32" component="p">
        From the <code>Top Menu</code> menu click on <code>Utilities</code> and select <code>Step</code>.
      </Typography>
      ...
      <Typography className="mb-32" component="p">
        ...
        <div className={clsx(classes.badge, 'new')}>Entity</div>,
