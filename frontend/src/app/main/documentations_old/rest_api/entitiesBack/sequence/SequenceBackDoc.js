...
function SequenceBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'episode': 'aaj:EP999'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with name as "SQ010", we take the URL
            <code>
              <b>localhost:8000/api/v1/entities/sequences/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/?name=SQ010</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'episode': 'aaj:EP999'
      ...
      <Typography className="mb-8" variant="h6">
        Find Extra data for a Sequence
      </Typography>
      <Typography className="mb-16" component="p">
        To get some extra data based on the object, we can add the parameters in the URL itself to
        get the parameter data based on that particular object. Below, "aaj:EP999:SQ010" in the URL
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/assets/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/shots/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/steps/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/tasks/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/versions/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010/notes/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'episode': 'aaj:EP999'
      ...
      <FuseHighlight component="pre" className="language-json mb-24">
        Sequence code: 204 No Content
      </FuseHighlight>
    </>
  );
}

export default SequenceBackDoc;
