...
function EpisodeBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'project': 'aaj'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with name as "EP999", we take the URL
            <code>
              <b>localhost:8000/api/v1/entities/episodes/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/?name= EP999</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'project': 'aaj'
      ...
      <Typography className="mb-8" variant="h6">
        Find Extra data for a Episode
      </Typography>
      <Typography className="mb-16" component="p">
        To get some extra data based on the object, we can add the parameters in the URL itself to
        get the parameter data based on that particular object. Below, "aaj:EP999" in the URL
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/assets/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/sequences/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/shots/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/steps/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/tasks/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/versions/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/episodes/aaj:EP999/notes/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'project': 'aaj'
      ...
      <FuseHighlight component="pre" className="language-json mb-24">
        Episode code: 204 No Content
      </FuseHighlight>
    </>
  );
}

export default EpisodeBackDoc;
