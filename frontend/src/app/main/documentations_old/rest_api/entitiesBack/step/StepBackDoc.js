...
function StepBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/steps/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/steps/aaj:EP999:SQ010:SH010:Animation/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/steps/?project=aaj</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'shot': 'aaj:EP999:SQ010:SH010'
      ...
      <Typography className="mb-16" component="p">
        ...
        "aaj:EP999:SQ010:SH010:Animation" in the URL represents the id of the object.
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <Typography className="mb-8 font-500 text-16 text-red">Important:</Typography>
        <ol>
          <li>
            ...
            <code>
              <b>
                localhost:8000/api/v1/entities/sequences/aaj:EP999:SQ010:SH010:Animation/assets/
              </b>
            </code>
          </li>
          <li>
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/steps/aaj:EP999:SQ010:SH010:Animation/versions/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/entities/steps/aaj:EP999:SQ010:SH010:Animation/notes/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
