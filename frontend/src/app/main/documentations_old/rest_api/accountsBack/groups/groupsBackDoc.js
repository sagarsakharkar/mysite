...
function groupsBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/users/groups/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/users/groups/1/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'name': 'TestGroup'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with name as "TestGroup", we take the URL
            <code>
              <b>localhost:8000/api/v1/users/groups/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/users/groups/?name=TestGroup</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'name': 'Test Group'
      ...
      <Typography className="mb-8" variant="h6">
        Find extra data for a Group
      </Typography>
      <Typography className="mb-16" component="p">
        To get some extra data based on the object, we can add the parameters in the URL itself to
        get the parameter data based on that particular object. Below, 18 in the URL represents the
        id of the object.
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <Typography className="mb-8 font-500 text-16 text-red">Important:</Typography>
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/users/groups/1/permissions/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
