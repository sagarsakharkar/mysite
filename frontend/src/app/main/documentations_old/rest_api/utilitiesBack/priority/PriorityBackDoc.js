...
function PriorityBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/priorities/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/priorities/1/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'color': '#a6acaf'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with name as "Low", we take the URL
            <code>
              <b>localhost:8000/api/v1/utilities/priorities/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/priorities/?name=Low</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'color': '#a6acaf'
      ...
      <FuseHighlight component="pre" className="language-json mb-24">
        Priority code: 204 No Content
      </FuseHighlight>
    </>
  );
}

export default PriorityBackDoc;
