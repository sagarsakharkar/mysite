...
function RoleBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/roles/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/roles/1/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'description': 'Admin'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with name as "Admin", we take the URL
            <code>
              <b>localhost:8000/api/v1/utilities/roles/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/roles/?name=Admin</b>
            </code>
          </li>
          <li>
            Method type:{' '}
