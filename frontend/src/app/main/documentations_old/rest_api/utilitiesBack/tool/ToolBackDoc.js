...
function ToolBackDoc() {
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/tools/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/tools/1/</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'description': 'Review Tasks'
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>
            For example, to find all objects with id as "1", we take the URL
            <code>
              <b>localhost:8000/api/v1/utilities/tools/</b>
            </code>
            Add a{' '}
            ...
            <br /> URL:{' '}
            <code>
              <b>localhost:8000/api/v1/utilities/tools/?id=1</b>
            </code>
          </li>
          <li>
            Method type:{' '}
  ...
  'description': 'Review Tasks'
      ...
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`{
  'description': 'Review Tasks Updated'
}`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
        Response:
  ...
  'description': 'Review Tasks Updated'
      ...
      <FuseHighlight component="pre" className="language-json mb-24">
        Tool code: 204 No Content
      </FuseHighlight>
    </>
  );
}

export default ToolBackDoc;
