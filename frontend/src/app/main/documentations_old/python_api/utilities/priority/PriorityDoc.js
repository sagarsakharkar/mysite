...
function PriorityDoc() {
  return (
    <>
      <Typography variant="h4" className="mb-24">Priority</Typography>
      <Typography className="mb-8" variant="h6">Create a Priority</Typography>
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>To create a Priority, you need to provide the following values;</li>
          <li><code><b>name:</b></code> It's the string for name of the priority</li>
      ...
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`data = {'name': 'Low', 'color': '#a6acaf'}
result = session.create('Priority', data)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      This will create a new Priority named "Low".
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <ol>
      ...
      <Typography className="mb-16" component="p">
      Output:<br></br>
      The variable result now contains a dictionary hash with the Priority information you created.
      </Typography>
  ...
  'color': '#a6acaf'
      ...
      <Typography className="mb-16" component="p">
        In addition, ase_session has returned the id that it has assigned to the Priority as well.
      </Typography>

      <hr></hr>

      <Typography className="mb-8" variant="h6">Find Multiple Prioritys</Typography>
      <Typography className="mb-16" component="p">
      Building the Query<br></br>
      Suppose we want to find out Priority with name as "Low".<br></br><br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`filters = [{'name': 'Low' }]
result = session.find('Priority', filters)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
  ...
  'color': '#a6acaf'
      ...
      <Typography className="mb-8" variant="h6">Find a Priority</Typography>
      <Typography className="mb-16" component="p">
      Building the Query<br></br>
      We are going to assume we know the 'id' of the Priority we're looking for in this example.<br></br><br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`id = 1
result = session.find_one('Priority', id)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      Pretty simple right? Well here's a little more insight into what's going on.
      </Typography>
  ...
  'color': '#a6acaf'
      ...
      <Typography className="mb-8" variant="h6">Update a Priority</Typography>
      <Typography className="mb-16" component="p">
      Building the data and calling update()<br></br>
      To update an Priority, you need to provide the id of the Priority and a list of fields you want to update.<br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`data = {'name': 'High'}
result = session.update('Priority', 1, data)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      This will update the Priority object.
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <ol>
  ...
  'color': '#a6acaf'
      ...
      <Typography className="mb-8" variant="h6">Delete a Priority</Typography>
      <Typography className="mb-16" component="p">
      Calling delete()<br></br>
      Deleting an entity in ase_session is pretty straight-forward. No extraneous steps required.
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`result = session.delete("Priority", 1)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      If the Priority was deleted successfully result will contain no body but only status code 204.
      </Typography>
    </>
  );
}
