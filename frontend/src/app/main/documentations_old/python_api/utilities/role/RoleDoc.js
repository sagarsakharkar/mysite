...
function RoleDoc() {
  return (
    <>
      <Typography variant="h4" className="mb-24">Role</Typography>
      <Typography className="mb-8" variant="h6">Create a Role</Typography>
      ...
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        ...
        <ol>
          <li>To create a Role, you need to provide the following values;</li>
          <li><code><b>name:</b></code> It's the string for name of the role</li>
          <li><code><b>description:</b></code> It's the string to describe the role</li>
        </ol>
      </div>
      <Typography className="mb-16" component="p">
      Example:
...
result = session.create('Role', data)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      This will create a new Role named "Admin".
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <ol>
      ...
      <Typography className="mb-16" component="p">
      Output:<br></br>
      The variable result now contains a dictionary hash with the Role information you created.
      </Typography>
  ...
  'description': 'Admin'
      ...
      <Typography className="mb-16" component="p">
        In addition, ase_session has returned the id that it has assigned to the Role as well.
      </Typography>

      <hr></hr>

      <Typography className="mb-8" variant="h6">Find Multiple Roles</Typography>
      <Typography className="mb-16" component="p">
      Building the Query<br></br>
      Suppose we want to find out Role with name as "Admin".<br></br><br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`filters = [{'name': 'Admin' }]
result = session.find('Role', filters)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
  ...
  'description': 'Admin'
      ...
      <Typography className="mb-8" variant="h6">Find a Role</Typography>
      <Typography className="mb-16" component="p">
      Building the Query<br></br>
      We are going to assume we know the 'id' of the Role we're looking for in this example.<br></br><br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`id = 1
result = session.find_one('Role',  id)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      Pretty simple right? Well here's a little more insight into what's going on.
      </Typography>
  ...
  'description': 'Admin'
      ...
      <Typography className="mb-8" variant="h6">Update a Role</Typography>
      <Typography className="mb-16" component="p">
      Building the data and calling update()<br></br>
      To update an Role, you need to provide the id of the Role and a list of fields you want to update.<br></br>
      Example:
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`data = {'description': 'updated_admin_description'}
result = session.update('Role', 1, data)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      This will update the Role object.
      </Typography>
      <div className="mb-16 px-12 py-8 border-1 border-red rounded-8">
        <ol>
  ...
  'id': 1, 
  'name': 'Admin', 
  'description': 'updated_admin_description'
}`}
      </FuseHighlight>
      <hr></hr>


      <Typography className="mb-8" variant="h6">Delete a Role</Typography>
      <Typography className="mb-16" component="p">
      Calling delete()<br></br>
      Deleting an entity in ase_session is pretty straight-forward. No extraneous roles required.
      </Typography>
      <FuseHighlight component="pre" className="language-jsx mb-32">
        {`result = session.delete("Role", 1)`}
      </FuseHighlight>
      <Typography className="mb-16" component="p">
      If the Role was deleted successfully result will contain no body but only status code 204.
      </Typography>
    </>
  );
}
