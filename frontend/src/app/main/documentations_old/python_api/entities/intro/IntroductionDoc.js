...
function IntroductionDoc() {
  return (
    <>
      ...
      This example shows you how to establish your initial connection to ase_session using jwt authentication. session represents your ase_session API instance.
      </Typography>
